    ...
    <footer>
      <div className="wrap">
        <div className="foot-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '40px', paddingBottom: '30px' }}>
          <div>
            <h4 style={{ color: 'var(--brass)', marginBottom: '20px', letterSpacing: '0.1em', fontSize: '15px' }}>QUICK LINKS</h4>
          ...
          <div>
            ...
            <p style={{ color: 'var(--brass)', fontSize: '11px', marginTop: '12px', marginBottom: '4px' }}>CORPORATE OFFICE (CHENNAI)</p>
            ...
            <p style={{ fontSize: '13px', lineHeight: '1.5' }}>SFD, P DOT G EMERALD, 16th A Cross Rd, Karuna Nagar, Electronic City Phase 1, Doddathoguru, Bengaluru - 560100, Karnataka, India</p>
            
            <p style={{ fontSize: '13px', marginTop: '16px' }}>info@adroitdesigns.in, fm@adroitdesigns.in</p>
